...
static constexpr const char kColorSource[] =
    ...
    "    tuple.g *= ColorInternals::maxChromaForLH(tuple.b, tuple.r) * 0.01;\n"
    "    return tuple.bgr;\n"
    "}\n"
    "\n"
    "lchToHsluv :: (float3 tuple) -> float3 {\n"
    "    tuple.g /= ColorInternals::maxChromaForLH(tuple.r, tuple.b) * 0.01;\n"
    "    return tuple.bgr;\n"
    "}\n"
    "\n"
    ...
    "    tuple.g *= ColorInternals::maxSafeChromaForL(tuple.b) * 0.01;\n"
    "    return tuple.bgr;\n"
    "}\n"
    "\n"
    ...
    "    tuple.g /= ColorInternals::maxSafeChromaForL(tuple.r) * 0.01;\n"
    "    return tuple.bgr;\n"
    "}\n"
    "\n"

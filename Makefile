...
EMBEDDED_MODULE_SOURCES = \
	...
	modules/PBR_module.bwsl \
	modules/PostFX.bwsl \
	modules/Random.bwsl \
	modules/Sampling.bwsl \
	modules/SDF.bwsl \
	modules/Spaces.bwsl
...
$(SPIRV_CROSS_WRAPPER_OBJ): $(SPIRV_CROSS_WRAPPER) Makefile | $(BUILD_DIR_MARKER)
	$(CXX) -c $(CXXFLAGS) $(SPIRV_CROSS_FLAGS) $(SPIRV_CROSS_INCLUDES) $(BWSL_INCLUDE_DIRS) \
		-MMD -MP -MF $(@:.o=.d) -o $@ $<

$(SPIRV_CROSS_WRAPPER_DEBUG_OBJ): $(SPIRV_CROSS_WRAPPER) Makefile | $(BUILD_DIR_MARKER)
...
$(BWSLC_OBJ): $(BWSLC_SRC) Makefile $(EMBEDDED_MODULE_HEADER) $(NATIVE_SPIRV_TOOLS_PREREQS) | $(BUILD_DIR_MARKER)
...
$(BWSLC_DEBUG_OBJ): $(BWSLC_SRC) Makefile $(EMBEDDED_MODULE_HEADER) $(NATIVE_SPIRV_TOOLS_PREREQS) | $(BUILD_DIR_MARKER)
...
# Unity builds depend on all included .cpp/.h/.inl files, not just their entry point.
-include $(BWSLC_OBJ:.o=.d) $(BWSLC_DEBUG_OBJ:.o=.d) \
	$(SPIRV_CROSS_WRAPPER_OBJ:.o=.d) $(SPIRV_CROSS_WRAPPER_DEBUG_OBJ:.o=.d) \
	$(WASM_DIR)/bwsl_wasm.d $(WASM_DIR)/spirv_cross_wrapper.d

...
NATIVE_BWSLC_CMD = $(MSVC_CXX) $(MSVC_RELEASE_FLAGS) $(MSVC_COMMON_FLAGS) \
	/Fe$(WIN_BWSLC_OUT) $(SPIRV_CROSS_WRAPPER_OBJ) $(BWSLC_SRC) $(MSVC_LINK_FLAGS)
NATIVE_BWSLC_DEBUG_CMD = $(MSVC_CXX) $(MSVC_DEBUG_FLAGS) $(MSVC_COMMON_FLAGS) \
	/Fe$(WIN_BWSLC_DEBUG_OUT) $(SPIRV_CROSS_WRAPPER_DEBUG_OBJ) $(BWSLC_SRC) $(MSVC_LINK_FLAGS)
...
NATIVE_BWSLC_CMD = $(CXX) $(CXXFLAGS) $(SPIRV_CROSS_FLAGS) $(SPIRV_CROSS_INCLUDES) $(BWSL_INCLUDE_DIRS) \
	-o $(BWSLC_OUT) $(SPIRV_CROSS_WRAPPER_OBJ) $(BWSLC_SRC)
NATIVE_BWSLC_DEBUG_CMD = $(CXX) $(CXXFLAGS_DEBUG) $(SPIRV_CROSS_FLAGS) $(SPIRV_CROSS_INCLUDES) $(BWSL_INCLUDE_DIRS) \
	-o $(BWSLC_DEBUG_OUT) $(SPIRV_CROSS_WRAPPER_DEBUG_OBJ) $(BWSLC_SRC)
...
bwslc-win-zig: $(ZIG_SPIRV_CROSS_WRAPPER_OBJ)
	$(ZIG) c++ -target $(ZIG_WIN_TARGET) $(ZIG_RELEASE_FLAGS) $(SPIRV_CROSS_FLAGS) \
		$(SPIRV_CROSS_INCLUDES) $(BWSL_INCLUDE_DIRS) \
		-o $(BWSLC_WIN_ZIG_OUT) $(ZIG_SPIRV_CROSS_WRAPPER_OBJ) $(BWSLC_SRC)
	@echo "Built: $(BWSLC_WIN_ZIG_OUT)"

bwslc-win-zig-debug: $(ZIG_SPIRV_CROSS_WRAPPER_DEBUG_OBJ)
	$(ZIG) c++ -target $(ZIG_WIN_TARGET) $(ZIG_DEBUG_FLAGS) $(SPIRV_CROSS_FLAGS) \
		$(SPIRV_CROSS_INCLUDES) $(BWSL_INCLUDE_DIRS) \
		-o $(BWSLC_WIN_ZIG_DEBUG_OUT) $(ZIG_SPIRV_CROSS_WRAPPER_DEBUG_OBJ) $(BWSLC_SRC)
